...
('Trần Thị Mộng Du', 2, 3, 4, '1992-11-07', '93978675',8,'0936231026','mongdu@gmail.com','Hải Châu, Đà Nẵng'),
('Văn Minh Tuấn', 3, 3, 4, '1988-03-17','95672301',12, '0365127783', 'tuan@yahoo.com', 'Quảng Nam'),
('Đỗ Kiệt Đạo', 6, 4, 4, '1977-02-11','23409135',25, '0999333999', 'badao@outlook.com', 'Liên Chiểu, Đà Nẵng'),
('Tăng Thị Thanh Hà', 4, 2, 1, '1985-09-19','26345903',15, '0364923789', 'hatang@.gmail.com', 'Huế'),
('Đồng Văn Phụt', 2, 1, 3, '1995-01-16','42671890',6, '0983401297', 'dongphuc@.gmail.com', 'Bình Định'),
('Đồng Văn Bất Tài', 1, 2, 1, '1993-05-10','86059271',8, '0367019236', 'taidong@.gmail.com', 'Lào Cai'),
('Song Văn Sinh', 1, 1, 3, '1985-01-17','97016507',9, '0985160267', 'songsinh@.gmail.com', 'Quảng Bình');
   -- insert KhachHang:
...
(2, 'Lý Thị Lụa', '1975-09-16','39716354','0123530298', 'lylua@gmail.com', 'Lạng Sơn'), -- platinium - total_payment < 10M
(3,'Lý Tiểu Long', '1963-12-06','17583923', '0909469230', 'tieulong@.gmail.com', 'Cao Bằng'), -- khách trước 2016
(1,'Hoàng Phi Hùng', '1969-09-11','376501291', '0359023190', 'phihung1271@.gmail.com', 'Hồ Chí Minh');
