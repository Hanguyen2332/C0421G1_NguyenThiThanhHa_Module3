...
public class UserControllerServlet extends HttpServlet {
    ...
    public void insertUser(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            if ("Create new user successful".equals(this.userService.insertUserTransaction(user))) {
                request.setAttribute("message", this.userService.insertUserTransaction(user));
                request.setAttribute("usersList", this.userService.selectAllUsers());
                dispatcher = request.getRequestDispatcher("select_all_users.jsp");
            } else {
                request.setAttribute("message", this.userService.insertUserTransaction(user));
